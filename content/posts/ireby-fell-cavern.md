...
{{ img_figure(src='/images/posts/ireby_fell/ireby_sink_hole.jpg',
              caption='The gigantic sinkhole that is directly above the entrance to Ireby Fell Cavern, which in turn is directly above Duke St passage, deep below.',
              alt='The gigantic sinkhole that is directly above the entrance to Ireby Fell Cavern.') }}
...
{{ img_figure(src='/images/posts/ireby_fell/ireby_duke_st.jpg',
              caption='A dry, sandy passage within Duke St in Ireby Fell Cavern.',
              alt='A dry, sandy passage within Duke St in Ireby Fell Cavern.') }}
...
{{ img_figure(src='/images/posts/ireby_fell/ireby_duke_st_stream.jpg',
              caption='Further down Duke St, the streamway rejoins the passage to one side.',
              alt='Further down Duke St, the streamway rejoins the passage to one side.') }}
